...
def main():
    ...
    # Filter out hosts with multiple BlackHat ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple BlackHat ports' % (ip_stats(ips)), file=sys.stderr)
