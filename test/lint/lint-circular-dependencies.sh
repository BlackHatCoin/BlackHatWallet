...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/blkc/addresseswidget -> qt/blkc/blkcgui -> qt/blkc/addresseswidget"
    "qt/blkc/navmenuwidget -> qt/blkc/blkcgui -> qt/blkc/navmenuwidget"
    "qt/blkc/blkcgui -> qt/blkc/qtutils -> qt/blkc/blkcgui"
    "qt/blkc/qtutils -> qt/blkc/snackbar -> qt/blkc/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zblkc/zblkcmodule -> validation"
    "wallet/fees -> wallet/wallet -> wallet/fees"
    "wallet/scriptpubkeyman -> wallet/wallet -> wallet/scriptpubkeyman"
    "wallet/wallet -> wallet/walletdb -> wallet/wallet"
    "wallet/wallet -> zblkcchain -> wallet/wallet"
    "zblkc/zblkcmodule -> zblkcchain -> zblkc/zblkcmodule"
    ...
    "qt/askpassphrasedialog -> qt/blkc/blkcgui -> qt/blkc/topbar -> qt/askpassphrasedialog"
    "qt/blkc/coldstakingwidget -> qt/blkc/tooltipmenu -> qt/blkc/blkcgui -> qt/blkc/coldstakingwidget"
    "qt/blkc/masternodeswidget -> qt/blkc/tooltipmenu -> qt/blkc/blkcgui -> qt/blkc/masternodeswidget"
    "qt/blkc/blkcgui -> qt/blkc/send -> qt/blkc/tooltipmenu -> qt/blkc/blkcgui"
    ...
    "chain -> legacy/stakemodifier -> validation -> zblkcchain -> chain"
