...
class ListReceivedTest (BlackHatTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 BLKC.
        ...
        # Send 1 BLKC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 BLKC sending them all (fee is 0.1 BLKC)
        ...
        # Confirm transaction (2 BLKC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 BLKC, send 0.6 BLKC + 0.05 BLKC fee
