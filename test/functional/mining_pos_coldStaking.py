#!/usr/bin/env python3
# Copyright (c) 2019-2020The PIVX developers
...
from test_framework.blkc_node import BlackHatTestNode
...
class BLKC_ColdStakingTest(BlackHatTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BlackHatTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 BLKC from the pot)
