...
class FullBlockTest(BlackHatTestFramework):
    ...
    def run_test(self):
        ...
        # BlackHat: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the BlackHat code has custom code which does so);
