...
"""Verify that starting BlackHat with -h works as expected."""
...
class HelpTest(BlackHatTestFramework):
    ...
    def run_test(self):
        self.log.info("Start BlackHat with -? for help text")
        ...
        self.log.info("Start BlackHat with -version for version information")
