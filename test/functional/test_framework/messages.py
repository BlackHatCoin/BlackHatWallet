...
COIN = 100000000 # 1 BLKC in satoshis
...
# Objects that map to blkcd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in blkcd indicates these should be deserialized as blocks
