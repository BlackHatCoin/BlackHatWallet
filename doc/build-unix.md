UNIX BUILD NOTES
====================
Some notes on how to build BlackHat Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile BlackHat Core and the dependencies,
...
This will build blkc-qt as well, if the dependencies are met.
...
memory available when compiling BlackHat Core. On systems with less, gcc can be
...
To build BlackHat Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
If you want to build blkc-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a blkc-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip blkcd" to strip the debug
...
Security
--------
To help make your BlackHat Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, BlackHat Core should be built with a non-executable stack
