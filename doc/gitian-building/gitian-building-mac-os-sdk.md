...
The script [extract-osx-sdk.sh](https://github.com/BlackHatCoin/BlackHatWallet/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
BlackHatWallet/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/BlackHatCoin/BlackHatWallet/blob/master/doc/README_osx.md) for troubleshooting tips.