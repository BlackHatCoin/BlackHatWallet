...
blkc.conf           | contains configuration settings for blkcd or blkc-qt
blkcd.pid           | stores the process id of blkcd while running
...
debug.log           | contains debug information and general logging generated by blkcd or blkc-qt
