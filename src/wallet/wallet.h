...
#ifndef BLKC_WALLET_H
#define BLKC_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_BLKC = 61000, // inherited version..
...
public:
     ...
     * BlackHat: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
