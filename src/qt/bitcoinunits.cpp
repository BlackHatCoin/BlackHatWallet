...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BLKC);
    unitlist.append(mBLKC);
    unitlist.append(uBLKC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case BLKC:
        return QString("blkc");
    case mBLKC:
        return QString("mblkc");
    case uBLKC:
        return QString::fromUtf8("ublkc");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZblkc)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZBLKC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZBLKC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZBLKC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZBLKC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
