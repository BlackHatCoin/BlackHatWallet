...
/* BlackHat GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BlackHat"
#define QAPP_ORG_DOMAIN "blackhatco.in"
#define QAPP_APP_NAME_DEFAULT "BLKC-Qt"
#define QAPP_APP_NAME_TESTNET "BLKC-Qt-testnet"
