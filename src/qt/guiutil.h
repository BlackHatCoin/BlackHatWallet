...
/** Utility functions used by the BlackHat Qt UI.
 */
namespace GUIUtil
{
...
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZblkc = false);
...
// Parse "blkc:" URI into recipient object, return true on successful parsing
