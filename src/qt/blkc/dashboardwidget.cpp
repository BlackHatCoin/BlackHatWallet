...
#include "qt/blkc/forms/ui_dashboardwidget.h"
...
DashboardWidget::DashboardWidget(BLKCGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &BLKCGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
