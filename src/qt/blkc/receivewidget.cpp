...
#include "qt/blkc/forms/ui_receivewidget.h"
#include "qt/blkc/requestdialog.h"
#include "qt/blkc/addnewcontactdialog.h"
#include "qt/blkc/qtutils.h"
#include "qt/blkc/myaddressrow.h"
...
ReceiveWidget::ReceiveWidget(BLKCGUI* parent) :
    PWidget(parent),
