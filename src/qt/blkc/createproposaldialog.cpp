...
#include "qt/blkc/createproposaldialog.h"
#include "qt/blkc/forms/ui_createproposaldialog.h"
...
CreateProposalDialog::CreateProposalDialog(BLKCGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.blackhat/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 BLKC");
