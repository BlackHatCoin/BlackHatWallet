...
#include "qt/blkc/txviewholder.h"
...
#include "config/blkc-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalBlkc = 0;
    qint64 totalZblkc = 0;
    QList<qreal> valuesBlkc;
    QList<qreal> valueszBlkc;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(BLKCGUI* _window);
    ~DashboardWidget();
