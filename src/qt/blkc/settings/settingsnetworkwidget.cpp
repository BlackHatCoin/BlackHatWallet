...
#include "qt/blkc/settings/settingsnetworkwidget.h"
#include "qt/blkc/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/blkc/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BLKCGUI* _window, QWidget *parent) :
