...
#include "qt/blkc/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/blkc/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BLKCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BLKCGUI::handleRestart()
