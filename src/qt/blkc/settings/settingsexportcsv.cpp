...
#include "qt/blkc/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(BLKCGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("BLKC_tx_csv_export(*.csv)") : tr("BLKC_addresses_csv_export(*.csv)"),
                                        nullptr);
