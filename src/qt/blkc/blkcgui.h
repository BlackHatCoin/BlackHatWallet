...
#ifndef BLKC_CORE_NEW_GUI_BLKCGUI_H
#define BLKC_CORE_NEW_GUI_BLKCGUI_H
...
#include "qt/blkc/dashboardwidget.h"
...
/**
  BlackHat GUI main class. This class represents the main window of the BlackHat UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BLKCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BLKCGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BLKCGUI();
...
#endif //BLKC_CORE_NEW_GUI_BLKCGUI_H
