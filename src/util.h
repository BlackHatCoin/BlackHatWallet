...
extern const char * const BLKC_CONF_FILENAME;
extern const char * const BLKC_PID_FILENAME;
extern const char * const BLKC_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("blkc-%s", name);
