 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called BlackHat (http://blackhatco.in),
 * which enables instant payments to anyone, anywhere in the world. BlackHat uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/blkc.conf are parsed in qt/blkc.cpp's main()
