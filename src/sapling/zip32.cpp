...
const unsigned char BLKC_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'B', 'L', 'K', 'C', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char BLKC_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
        {'B', 'x', 'T', 'a', 'd', 'd', 'r', 'T', 'o', 'S', 'a', 'p', 'l', 'i', 'n', 'g'};
...
{
    CBLAKE2bWriter h(SER_GETHASH, 0, BLKC_HD_SEED_FP_PERSONAL);
    h << seed;
    return h.GetHash();
}
