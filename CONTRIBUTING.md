Contributing to BlackHat Core
============================

The BlackHat Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BlackHat Core project, and is not to be
confused with overall BlackHat Network Protocol consensus changes.

Whether a pull request is merged into BlackHat Core rests with the project merge
...
Patches that change BlackHat consensus rules are considerably more involved than
...
Where a patchset proposes to change the BlackHat consensus, it must have been
...
The project leader is the release manager for each BlackHat Core release.
